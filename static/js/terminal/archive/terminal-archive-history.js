...
(function (window, document) {
    ...
    function initialize(context) {
        const service = {
            async list(parameters = {}) {
                ...
                return context.api.get("archive/history", parameters);
            }
        };

        context.registerService?.("archive-history", service);
        return service;
    }
    ...
    const commands = [{
        ...
        category: "archive",
        description: "Display archive publication history.",
        usage: "archive-history [query] [limit]",
    ...
    window.SpeciedexTerminalArchiveHistory = api;
