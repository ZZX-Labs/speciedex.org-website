...
========================================================================
Speciedex.org
Terminal WordCloud Visualization
========================================================================
...
(function (window, document) {
    ...
    function render(data = [], options = {}) {
        ...
        container.setAttribute(
            "aria-label",
            options.label || "WordCloud visualization"
        );
        ...
        context2d.fillText("WordCloud", 24, 32);
